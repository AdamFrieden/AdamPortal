// src/starclans/components/dnd/DraggableListContainer.tsx
...
export interface DraggableListContainerProps { // Renamed interface
...
export const DraggableListContainer = forwardRef<HTMLDivElement, DraggableListContainerProps>( // Renamed component and props type
  (
    {
      children,
      handleProps,
      ...
      ...props
    }: DraggableListContainerProps, // Use renamed props type
    ref
  ) => {
...
DraggableListContainer.displayName = 'DraggableListContainer'; // Updated display name
